...
var DemoList = class extends import_coc.BasicList {
  constructor(nvim) {
    super(nvim);
    this.name = "demo_list";
    this.description = "CocList for coc-github-comments";
...
async function activate(context) {
  import_coc2.window.showMessage(`coc-github-comments works!`);
  context.subscriptions.push(
    import_coc2.commands.registerCommand("coc-github-comments.Command", async () => {
      import_coc2.window.showMessage(`coc-github-comments Commands works!`);
    }),
    import_coc2.listManager.registerList(new DemoList(import_coc2.workspace.nvim)),
    import_coc2.sources.createSource({
      name: "coc-github-comments completion source",
      doComplete: async () => {
